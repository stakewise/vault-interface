...
export type FormatTokenValue = (value: bigint | string, isMinimalValueShow?: boolean) => string

type Wrapper = E2E.FixtureMethod<FormatTokenValue>
...
export const createFormatTokenValue: Wrapper = () => (
  (value: bigint | string, isMinimalValueShow: boolean = false) => {
    try {
