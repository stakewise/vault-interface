...
export default {
  title: {
    ...
    pt: 'Reivindicar recompensas',
    de: 'Prämien einfordern',
    zh: '领取奖励',
  },
  description: {
    en: `
      Claim the additional rewards you've earned by staking in the vaults and using your stake in the StakeWise ecosystem
    `,
    ru: `
    ...
    `,
    de: `
      Fordern Sie die zusätzlichen Belohnungen an, die Sie durch das Staking in den Vaults und die Nutzung Ihres Einsatzes im StakeWise-Ökosystem verdient haben
    `,
    zh: `
      通过在Vaults里进行质押并在StakeWise生态系统中使用您的质押，领取您所赚取的额外奖励
    `,
  },
}
