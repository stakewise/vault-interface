export default {
  tooltipNeedStaking: {
    ...
    fr: 'Vous ne pouvez mint {mintToken} qu\'après avoir staké {depositToken} dans le Vault.',
    es: 'Puede hacer mint de {mintToken} solo después de hacer staking de {depositToken} en el Vault.',
    pt: 'Você pode fazer mint de {mintToken} apenas após fazer staking de {depositToken} no Vault.',
  ...
  tooltipNeedValidators: {
    ...
    fr: 'Le Vault doit avoir au moins un validateur enregistré pour mint {mintToken}.',
    es: 'El Vault debe tener al menos un validador registrado para hacer mint de {mintToken}.',
    pt: 'O Vault deve ter pelo menos um validador registrado para fazer mint de {mintToken}.',
    de: 'Der Vault muss mindestens einen registrierten Validator haben, um {mintToken} zu minten.',
    zh: 'Vault必须至少有一个注册验证者才能铸造{mintToken}。',
  },
  capacityError: {
